package com.hrsst.smarthome.mygridview.lib;
...
import com.hrsst.smarthome.mygridview.lib.internal.BaseLoadingLayout;
import com.hrsst.smarthome.mygridview.lib.internal.LoadingLayout;
import com.hrsst.smarthome.mygridview.lib.internal.SpecialTopLoadingLayout;
import com.hrsst.smarthome.mygridview.lib.internal.SpecialTopNoPicUpAndDown;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_ptrMode)) {
			mode = a.getInteger(R.styleable.PullToRefresh_ptrMode, MODE_PULL_DOWN_TO_REFRESH);
		}
