...
import com.hrsst.smarthome.util.PhoneWatcher;
...
public class MonitorActivity extends BaseMonitorActivity implements
	...
	ImageView screenshot, hungup, close_voice, send_voice, img_reverse,
			steering_wheel, open_door, defence_state,baidu1,baidu2,baidu3,baidu4,baidu5,control_yuzhiwei;
	AudioManager mAudioManager = null;
	int mCurrentVolume, mMaxVolume;
	PhoneWatcher mPhoneWatcher;
	RelativeLayout control_bottom,yuzhiwei;
	...
	Button bt_top, bt_bottom, bt_left, bt_right,szyzw,ckyzw;
	...
	public void initComponent() {
		...
		control_yuzhiwei = (ImageView) findViewById(R.id.control_yuzhiwei);
		...
		text_number.setText("P2PConnect.getNumber()");
		...
		control_yuzhiwei.setOnClickListener(this);
	}
	...
	private BroadcastReceiver mReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context arg0, Intent intent) {
			if (intent.getAction().equals(Constants.P2P.P2P_REJECT)) {
				reject();
			} else if (intent.getAction().equals(Constants.P2P.RET_PRESET_MOTORPOS_STATUS)){
