...
public class Constants {
	...
	public static class WeekType{
		public static final String EVERY_DAY_TYPE="每天";
		public static final String WORKING_DAY_TYPE="工作日";
		public static final String ONCE_TYPE="执行一次";
		public static final String TODAY="今天";
		public static final String TOMORROW="明天";
		public static final String WEEKEN_DAY_TYPE="周末";
	}
