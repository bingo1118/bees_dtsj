...
public class AccountPersist {
	...
	public void setActiveAccountNoSessionId(Context context,Account account){
	...
	public Account getActiveAccountInfoNoSessionId(Context context){
		SharedPreferences preference = context.getSharedPreferences(ACCOUNT_SHARED_PREFERENCE, context.MODE_PRIVATE);
		Editor editor = preference.edit();
		String three_number = preference.getString(ACC_INFO_3C, "");
		String phone = preference.getString(ACC_INFO_PHONE, "");
		...
		if(three_number.equals("")){
			...
			return new Account(three_number,email, phone, code1, code2 ,countryCode);
		}
	}
